...
type Props = {
  onClose: (value: ITeacherModel | null) => void;
  teacherEdit: ITeacherModel;
};

const Update = ({onClose, teacherEdit}: Props) => {
  ...
  useEffect(() => {
    form.setFieldsValue(teacherEdit);
  }, [form, teacherEdit]);
